...
class face_model(tf.keras.Model):
    ...
    def __init__(self, params):
        ...
        img_size = (params.image_size, params.image_size, 16)
        intermediate_size = (params.image_size, params.image_size, 12)
        input_size = (params.image_size, params.image_size, 3)
        self.conversion_layer = tf.keras.layers.Conv2D(16, (3,3), padding='same', activation='relu', input_shape=img_size)
        self.conversion_layer_3 = tf.keras.layers.Conv2D(10, (3,3), padding='same', activation='relu')
