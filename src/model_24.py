...
class face_model(tf.keras.Model):
    ...
    def __init__(self, params):
        ...
        img_size = (params.image_size, params.image_size, 24)
        intermediate_size = (params.image_size, params.image_size, 12)
        input_size = (params.image_size, params.image_size, 3)
        self.conversion_layer = tf.keras.layers.Conv2D(24, (3,3), padding='same', activation='relu', input_shape=img_size)
        self.conversion_layer_2 = tf.keras.layers.Conv2D(18, (3,3), padding='same', activation='relu')
        self.conversion_layer_3 = tf.keras.layers.Conv2D(12, (3,3), padding='same', activation='relu')
        self.conversion_layer_4 = tf.keras.layers.Conv2D(6, (3,3), padding='same', activation='relu')
    ...
    def call(self, images):
        ...
        x = self.conversion_layer_3(x)
        x = self.conversion_layer_4(x)
